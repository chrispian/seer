...
{
    public function slug(): string { return 'fs'; }
    public function capabilities(): array { return ['read','write','list']; }

    protected function root(): string { return Config::get('fragments.tools.fs.root'); }
