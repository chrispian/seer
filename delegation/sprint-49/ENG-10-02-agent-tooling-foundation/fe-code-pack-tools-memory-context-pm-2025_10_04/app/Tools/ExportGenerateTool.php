...
class ExportGenerateTool implements ToolContract
{
    ...
    public function name(): string { return 'export.generate'; }
    public function scope(): string { return 'export.read'; }
    ...
    public function run(array $payload): array
    {
        ...
        if ($format === 'md') $content = "# Export\n\n```json\n" . $content . "\n```\n";
        if ($format === 'txt') $content = $content;
